...
class SignallingSession(SessionBase):
    ...
    def get_bind(self, mapper=None, clause=None):
        """Return the engine or connection for a given models or
...
class BaseQuery(orm.Query):
    ...
    Override the query class for an individual models by subclassing this and setting :attr:`~Model.query_class`.
    """
...
class SQLAlchemy(object):
    ...
    .. versionadded:: 2.1
       ...
       The `model_class` parameter was added, which allows a custom models
    ...
    def make_declarative_base(self, model, metadata=None):
        ...
        :param model: base models class (or a tuple of base classes) to pass
        ...
        .. versionchanged 2.3.0::
            ``models`` can be an existing declarative base in order to support
