...
def should_set_tablename(cls):
    ...
    * Abstract models should not have one generated.
    ...
    models looks like single or joined-table inheritance. If no primary key is
...
class NameMetaMixin(object):
    ...
    def __table_cls__(cls, *args, **kwargs):
        ...
        final table object that the models will use.
        ...
        # allows reflected tables to be applied to models by name
...
class Model(object):
    """Base class for SQLAlchemy declarative base models.
    ...
    #: Convenience property to query the database for instances of this models
