...
SQLite's typing models is based on naming conventions.  Among other things, this
...
The Python DBAPI specification also calls for a connection models that is
...
within a transaction, and with its autoflush models, may emit DML preceding
