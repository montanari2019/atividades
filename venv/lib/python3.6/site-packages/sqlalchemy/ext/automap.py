...
models from an existing database on the fly.  By addressing the issue strictly
...
The simplest usage is to reflect an existing database into a new models.
...
generate missing relationships given an otherwise complete models that fully
